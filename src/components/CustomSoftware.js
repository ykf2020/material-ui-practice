...
function CustomSoftware({setValue, setSelectedIndex}) {
  ...
  return (
    <Grid container direction="column">
      <Grid item container direction="row" justifyContent={matchesMD ? "center" : undefined} className={classes.rowContainer} style={{marginTop: matchesXS ? "1em" : "2em"}}>
        <Hidden mdDown>
      ...
      <Grid item container justifyContent="space-between" direction={matchesMD ? "column" : "row"} alignItems={matchesMD ? "center" : undefined } className={classes.rowContainer}>
        <Grid item container className={classes.itemContainer} md style={{marginBottom:matchesMD ? "15em" : 0}} direction={matchesSM ? "column" : "row"}>
          <Grid item container direction="column" md >
            ...
            <Grid item>
              <Typography variant="body1" paragraph align={matchesSM ? "center" : undefined }>Reduce Errors. Reduce Waste. Reduce Cost.</Typography>
              <Typography variant="body1" paragraph align={matchesSM ? "center" : undefined }>Billions are spent annually on the purchasing, printing, and distribution of paper. On the rop of the massive environmental impact this has, it causes harm to bottom line as well.</Typography>
      ...
      <Grid item container direction="row" style={{marginTop: "20em", marginBottom: "20em"}} className={classes.rowContainer}>
        <Grid item container direction="column" alignItems='center'>
          ...
          <Grid item className={classes.itemContainer}>
            ...
            <Typography variant="body1" align="center" paragraph>Many problems are merely sysmptoms of larger, underlying issues.</Typography>
      ...
      <Grid item container justifyContent="space-between" style={{marginBottom:"20em"}} direction={matchesMD ? "column" : "row"} alignItems={matchesMD ? "center" : undefined } className={classes.rowContainer}>
        <Grid item container className={classes.itemContainer} md style={{marginBottom:matchesMD ? "15em" : 0}} direction={matchesSM ? "column" : "row"}>
          <Grid item container direction="column" md >
            <Grid item>
            ...
            <Grid item>
              ...
              <Typography variant="body1" paragraph align={matchesSM ? "center" : undefined }>We can help you identify processes with time or event based actions which can now easily be automated.</Typography>
              <Typography variant="body1" paragraph align={matchesSM ? "center" : undefined }>Increasing efficiency increases profits, leaving you more time to focus on your business, not busywork.</Typography>
            </Grid>
          </Grid>
          <Grid item md>
        ...
        <Grid item container className={classes.itemContainer} md>
          ...
          <Grid item container direction="column" md>
            ...
            <Grid item>
              ...
              <Typography variant="body1"  align={matchesSM ? "center" : "right" } paragraph>By prioritizing users and the real ways they interact with technology we're able to develop unique, personable experience that solve problems rather than create new ones.</Typography>
            </Grid>
          </Grid>
        </Grid>
      </Grid>
