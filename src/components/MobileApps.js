    ...
    <Grid container direction="column">
      <Grid item container direction="row" justifyContent={matchesMD ? "center" : undefined} className={classes.rowContainer} style={{marginTop: matchesXS ? "1em" : "2em"}}>
        ...
        <Grid item container direction="column" className={classes.heading}>
          <Grid item>
            <Typography align={matchesMD ? "center" : "undefined"} variant="h2">iOS/Andorid App Development</Typography>
          </Grid>
          <Grid item>
      ...
      <Grid item container direction={matchesSM ? "column": "row"} className={classes.rowContainer} style={{marginTop: "15em", marginBottom:"15em"}}>
        <Grid item container direction="column" md>
          ...
          <Grid item>   
            <Typography align={matchesSM ? "center" : undefined} variant="body1" gutterBottom paragraph>
            ...
            <Typography align={matchesSM ? "center" : undefined} variant="body1" gutterBottom paragraph>
              This allows you to extend your reach, reinvent interaction, and develop a stronger relationship with your users than ever before.
            </Typography>
          </Grid>
        </Grid>
        <Grid item md>
        ...
        <Grid item container direction="column" md>
          ...
          <Grid item>   
            <Typography align={matchesSM ? "center" : "right"}  variant="body1" gutterBottom paragraph>
              Our cutting-edge development process allows us to create apps for iPhone, Android, and tablets - all at the same time.
            </Typography>
            <Typography align={matchesSM ? "center" : "right"}  variant="body1" gutterBottom paragraph>
              This is significantly reduces costs and creates a more unified brand experience across all devices.
            </Typography>
          </Grid>
        </Grid>
      </Grid>
