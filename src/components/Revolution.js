  ...
  return (
    <Grid container direction="column">
      <Grid item className={classes.rowContainer} style={{marginTop:"2em"}}>
        <Typography  variant='h2' style={{ fontFamily: "Pacifico"}} align={matchesMD ? "center" : undefined}>The Revolution</Typography>
      </Grid>
      <Grid item container direction={matchesMD ? "column" : "row"}  alignItems='center' className={classes.rowContainer} style={{marginTop: "5em"}}>
        ...
        <Grid item container direction="column" lg style={{maxWidth: "40em"}}>
          ...
          <Grid item>
            ...
            <Typography align={ matchesMD ? "center":'right'} variant='body1' paragraph>
              What once was confined to huge rooms and teams of engineers now resides in every single one of hands. Harnessing this unlimited potential by using it to solve problems and better lives is at the heart of everything we do.
            </Typography>
            <Typography align={ matchesMD ? "center":'right'} variant='body1' paragraph>
              We want to hep[ businesses capitalize on the latest and greatest technology. The best way to predict the future is to be the one building it, and we want to help guide the world into this next chapter of technological expansion, exploration, and innovation.
            </Typography>
            <Typography align={ matchesMD ? "center":'right'} variant='body1' paragraph>
              By holding ourselves to rigorous standards and pristine quality, we can ensure you have the absolue best tools necessary to thrive in this new frontier.
            </Typography>
            <Typography align={ matchesMD ? "center":'right'} variant='body1' paragraph>
      ...
      <Grid item container direction={ matchesMD ? "column" : 'row'} className={classes.rowContainer} style={{background:"#B3B3B3", height:"90em"}}>
      ...
      <Grid item container direction={ matchesMD ? "column" : 'row'} className={classes.rowContainer} style={{background:"#FF7373", height:"90em"}}>
        <Grid item container direction='column' lg alignItems={ matchesMD ? "center": undefined}>
          <Grid item>
      ...
      <Grid item container direction={ matchesMD ? "column" : 'row'} className={classes.rowContainer} style={{background:"#39B54A", height:"90em"}}>
        <Grid item container direction='column' lg alignItems={ matchesMD ? "center": undefined}>
          <Grid item>
        ...
        <Grid item lg style={{alignSelf:"center"}}>
          <img src={review} alt="magnifying class" width="100%"/>
        </Grid>
      </Grid>
      <Grid item container direction={ matchesMD ? "column" : 'row'} className={classes.rowContainer} style={{background:"#A67C52", height:"90em"}}>
        <Grid item container direction='column' lg alignItems={ matchesMD ? "center": undefined}>
          <Grid item>
      ...
      <Grid item container direction={ matchesMD ? "column" : 'row'} className={classes.rowContainer} style={{background:"#FBB03B", height:"90em"}}>
        <Grid item container direction='column' lg alignItems={ matchesMD ? "center": undefined}>
          <Grid item>
      ...
      <Grid item container direction={ matchesMD ? "column" : 'row'} className={classes.rowContainer} style={{background:"#C1272D", height:"90em"}}>
        <Grid item container direction='column' lg alignItems={ matchesMD ? "center": undefined}>
          <Grid item>
      ...
      <Grid item container direction={ matchesMD ? "column" : 'row'} className={classes.rowContainer} style={{background:"#8E45CE", height:"90em"}}>
        <Grid item container direction='column' lg alignItems={ matchesMD ? "center": undefined}>
          <Grid item>
      ...
      <Grid item container direction={ matchesMD ? "column" : 'row'} className={classes.rowContainer} style={{background:"#29ABE2", height:"90em"}}>
        <Grid item container direction='column' lg alignItems={ matchesMD ? "center": undefined}>
          <Grid item>
