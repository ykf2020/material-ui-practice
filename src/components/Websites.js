...
function Websites({setSelectedIndex, setValue}) {
  ...
  return (
    <Grid>
      ...
      <Grid item container direction={matchesSM ? "column" : "row"} alignItems='center' justifyContent='flex-end' className={classes.rowContainer} style={{marginBottom:"15em", marginTop:"15em"}}>
        <Grid item>
          <Grid container direction="column">
            <Grid item>
              <Typography variant="h4"  gutterBottom align={matchesSM ? "center" : undefined}>E-Commerce</Typography>
            </Grid>
            <Grid item>
      ...
      <Grid item container direction={matchesSM ? "column" : "row"} alignItems='center' className={classes.rowContainer}>
        ...
        <Grid item style={{marginLeft: matchesSM ? 0 : "1em"}} className={classes.paragraphContainer}>
          <Typography variant='body1' align={matchesSM ? "center" : undefined}>
            Draw prople in with a dazzling website. Showing off your products online is a great way to help customers decide what's right for them before visiting in person.
          </Typography>
        </Grid>
      </Grid>
      <Grid item container direction={matchesSM ? "column" : "row"} alignItems='center' justifyContent='flex-end' className={classes.rowContainer} style={{marginBottom:"15em", marginTop:"15em"}}>
        <Grid item>
          <Grid container direction="column">
            <Grid item>
              <Typography variant="h4"  gutterBottom align={matchesSM ? "center" : undefined}>Search Engine<br/> Optimization</Typography>
            </Grid>
            <Grid item>
              <img src={seo} alt="website stainding on winner's podium"/>
            </Grid>
          </Grid>
        </Grid>
        <Grid item style={{marginLeft: matchesSM ? 0 : "1em"}} className={classes.paragraphContainer}>
          <Typography variant='body1' paragraph align={matchesSM ? "center" : undefined}>
            How ofter have you ever been to the second page of Google results?
          </Typography>
          <Typography variant='body1' paragraph align={matchesSM ? "center" : undefined}>
